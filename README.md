...
[![Build Status](https://travis-ci.com/superoo7/go-gecko.svg?branch=master)](https://travis-ci.com/superoo7/go-gecko) [![GoDoc](https://godoc.org/github.com/cowdude/go-gecko?status.svg)](https://godoc.org/github.com/cowdude/go-gecko)
...
```
go get -u github.com/cowdude/go-gecko
```
...
import (
	...
	coingecko "github.com/cowdude/go-gecko/v3"
)
